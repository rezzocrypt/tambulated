<template>
    <a class="link" href="#">
        <div class="element">
            <div class="icon" :style="icon != null ? `background: ${icon}`:''"></div>
